...
try {
    ...
    $sql = "UPDATE directed SET title = ?, task = ?, instock = ?, shipment = ?, arrivals = ?, arrival_unit = ?, reserve = ?, reserve_unit = ?, comment = ?, file = ?, postcode = ?, prefecture = ?, city = ?, address = ?, building = ?, phone = ? WHERE id = ?";
    ...
    $stmt->bindValue(17, $id, PDO::PARAM_INT);
    $stmt->execute();
    $dbh = null;
